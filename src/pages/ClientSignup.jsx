...
import { Building2, User, Mail, Lock, AlertCircle, CheckCircle2 } from 'lucide-react';
...
export default function ClientSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await base44.functions.invoke('signupClient', formData);
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#f5f3ed] via-[#ebe9dd] to-[#f5f3ed] relative overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 w-full max-w-md px-4">
          <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-xl border border-[#e8e6de]/50 text-center">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#7a8a5e] to-[#6d7d51] flex items-center justify-center mx-auto mb-6">
              <CheckCircle2 className="w-8 h-8 text-white" />
            </div>
            <h2 className="text-3xl font-bold text-[#2d3319] mb-3">Signup Submitted!</h2>
            <p className="text-[#6b7055] mb-6">
              Your signup request has been sent to our media specialist team for approval. You'll receive an email confirmation once approved.
            </p>
            <p className="text-sm text-[#9ca38a] mb-6">
              Approval typically takes 24-48 hours.
            </p>
            <Button
              onClick={() => window.location.href = createPageUrl('ClientLogin')}
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-xl border border-[#e8e6de]/50">
            <h1 className="text-3xl font-bold text-[#2d3319] mb-2">Client Signup</h1>
            <p className="text-[#6b7055] mb-8">Create your business account</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <Building2 className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#a8b88c]" />
                  <Input
                    type="text"
                    name="business_name"
              ...
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#a8b88c]" />
                  <Input
                    type="text"
                    name="contact_name"
